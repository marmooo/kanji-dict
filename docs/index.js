class Kanji{constructor(e){this.list=e,this.dict=this.setDict(this.list)}setDict(e){const t={};for(let n=0;n<e.length;n++){const s=e[n];for(let e=0;e<s.length;e++){const o=s[e];t[o]?t[o].push(n):t[o]=[n]}}return t}getGrade(e){const n=Array.from(e);let t=-1;for(let s=0;s<n.length;s++){const o=n[s],e=this.dict[o];if(!e)continue;for(let n=0;n<e.length;n++)t<e[n]&&(t=e[n])}return t}}const JISCode1=`
亜
唖
娃
阿
