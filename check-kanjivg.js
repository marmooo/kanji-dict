...
var jis1 = fs.readFileSync('jis/1.lst', 'utf-8').split('\n').slice(0, -1);
var jis2 = fs.readFileSync('jis/2.lst', 'utf-8').split('\n').slice(0, -1);
var jis3 = fs.readFileSync('jis/3.lst', 'utf-8').split('\n').slice(0, -1);
var jis4 = fs.readFileSync('jis/4.lst', 'utf-8').split('\n').slice(0, -1);
